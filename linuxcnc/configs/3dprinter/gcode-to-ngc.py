...
#    Copyright 2017 Bart van Hest (dabit AT icecoldcomputing DOT com)
#
#    This script is an adaptation of A.Roesslers scripot for the DaBit3D printer
#
...
# Note: axes A and Z are swapped
replacements = [
    [r'(G(?:0|1|2|3|92).*)(?:Z)([-\+]?[\d\.].*)', r'\1A\2'],
    [r'(G(?:0|1|2|3|92).*)(?:E)([-\+]?[\d\.].*)', r'\1Z\2'],
    [r'G10', r'G22'],
    [r'G11', r'G23'],
    [r'M1(04|06|09|40|41|90|91)(.*)(?:S)([\d\.].*)', r'M2\1\2P\3'],
    [r'M107', r'M207'],
    [r'.*M82.*', '']
]
